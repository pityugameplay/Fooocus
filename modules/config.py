...
checkpoint_downloads = get_config_item_or_set_default(
    ...
    default_value={
        ...
        "sdxxxl_v30": "https://drive.usercontent.google.com/download?id=1zbelIborfWCv4g3tF1cOJ4wlUCFJi3As&export=download&authuser=1&confirm=t&uuid=470624a6-0546-42af-bdfb-db267f3a9a87&at=APZUnTVumcx6V7owoYteSDdgJ4lP%3A1707583870938"
...
lora_downloads = get_config_item_or_set_default(
    ...
    default_value={
        ...
        # "w3t_SDXL.safetensors": "https://civitai.com/api/download/models/152713",
        # "handbrav3_SDXL.safetensors": "https://civitai.com/api/download/models/177308",
        # "Sweaty_Realism_4-000006.safetensors": "https://civitai.com/api/download/models/302404",
    },
    validator=lambda x: isinstance(x, dict) and all(isinstance(k, str) and isinstance(v, str) for k, v in x.items())
)
